...
def create_food_category(obj_in: FoodCategoryCreate, db: Session = Depends(get_db)):
...
def update_food_category(category_id: int, obj_in: FoodCategoryUpdate, db: Session = Depends(get_db)):
...
def delete_food_category(category_id: int, db: Session = Depends(get_db)):
