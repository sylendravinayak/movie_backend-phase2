...
class Settings():
    ...
    MONGODB_URL: str = os.getenv("MONGODB_URL", "mongodb://localhost:27017/mydb")
    
    # JWT
    SECRET_KEY_ACCESS: str = os.getenv("SECRET_KEY", "your-secret-ACCESS")
    SECRET_KEY_REFRESH: str = os.getenv("SECRET_KEY", "your-secret-REFRESH")
    ALGORITHM: str = "HS256"
